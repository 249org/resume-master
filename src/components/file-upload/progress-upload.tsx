...
export default function ProgressUpload({
  ...
  return (
    <div className={cn('w-full max-w-2xl rounded-xl', className)}>
      {/* Upload Area */}
      <div
        className={cn(
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">Free ATS Check</h3>
          ...
          <Button
            ...
            className="bg-secondary text-secondary-foreground hover:bg-secondary/90 cursor-pointer rounded-full"
          >
            <UploadIcon />
          ...
          >
            *full detailed report requires a free account
          </Badge>
        </div>
      </div>
